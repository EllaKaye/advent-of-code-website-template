...
The two main functions for managing files, already mentioned above, are `aoc_new_year()` and `aoc_new_day()`. In the descriptions below, the `YYYY` and `DD` placeholders are used to indicate where the year and day values will be inserted.
...
## Examples posts
The template comes ready to go for 2023, 
and also with an example introduction and day 1 post for 2022, 
...
## Examples
This template span out from my work on an Advent of Code website for myself, links below. 
